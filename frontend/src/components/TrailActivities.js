      ...
      <div className="max-w-6xl mx-auto px-5 py-5 font-sans w-full">
        <div className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <h3 className="text-xl font-semibold text-green-700 mb-2">Randonnées Guides</h3>
              <p className="text-gray-700">
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <h3 className="text-xl font-semibold text-green-700 mb-2">Ateliers Techniques</h3>
              <p className="text-gray-700">
